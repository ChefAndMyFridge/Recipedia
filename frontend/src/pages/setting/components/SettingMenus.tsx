...
const SettingMenus = () => {
  ...
  return (
    <div className="w-full h-[60%] flex flex-col items-center justify-center gap-8">
      <button
        className="w-[90%] h-24 bg-white rounded-lg shadow-md flex items-center px-4 gap-4"
        onClick={() => navigate("/setting/favorite")}
      >
      ...
      <div className="w-[90%] h-24 bg-white rounded-lg shadow-md flex items-center  px-4 gap-4">
        ...
        <button className={BANNER_CLASS} onClick={() => navigate("/setting/preference")}>
